...
![.png](/img/note/mybatis-lifezhou.png)
...
![-1.png](/img/note/mybatislife1.png)
...
![-2.png](/img/note/mybatislife-2.png)

**（1）Executor执行器的创建流程：**

![-3.png](/img/note/mybatislife-3.png)
...
![-5.png](/img/note/mybatis-5-5.png)
...
* 条件构造器：通过`EntityWrapper<T>`（实体包装类），可以用于拼接SQL 语句，并且支持排序、分组查询等复杂的SQL。
