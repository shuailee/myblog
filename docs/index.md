...
heroText: klein's blog
tagline: 这是一个混沌的世界，黄昏时分无故人
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: Java
    details: Java，JVM，JavaApi
    link: /java/ # 可选
    imgUrl: /img/java.jpg # 可选
  - title: 架构
    details: 分布式理论，云原生，容器
    link: /system/
...
### 📚Blog
这是一个兼具博客文章、知识管理、文档查找的个人网站，主要内容是Web前端技术。如果你喜欢这个博客&主题欢迎到[GitHub](https://github.com/shuailee/vuepress-theme-vdoing)点个Star、获取源码，或者交换[友链](/friends/) ( •̀ ω •́ )✧

### 🎨Theme
本站主题是根据[VuePress](https://vuepress.vuejs.org/zh/)的默认主题修改而成。取名`Vdoing`(维度)，旨在轻松打造一个`结构化`与`碎片化`并存的个人在线知识库&博客，让你的知识海洋像一本本书一样清晰易读。配合多维索引，让每一个知识点都可以快速定位！ 更多[详情](https://github.com/shuailee/vuepress-theme-vdoing)。
...
- **GitHub**: <https://github.com/shuailee>
